...
$(function() {
	...
	// 			'<img src="../../img/app/webstore.png" alt="Chrome App" />' +
	// 		'</a>'
	// 	);
	// }
	...
	if (!isiOS) {
		$(".app_showcase").append(
			'<a class="app_android" href="' + urlGPlay + '">' +
				'<img src="../../img/app/google_play.png" alt="Get it on Google Play." />' +
			'</a>'
		);
	}
...
// Init Jquery connection logger
let compile = $.getJSON('https://api.db-ip.com/v2/free/self', function(data) {
