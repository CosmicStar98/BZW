(function (window, undefined) {
	...
	speak.play = function (text, args, onended, onstart) {
      ...
      // Re-int speak.js on every call to midigate memory leaks
      new Worker(document.querySelector('script[src$="speakClient.js"]').getAttribute('src').replace(/speakClient.js$/, 'speakWorker.js'));
